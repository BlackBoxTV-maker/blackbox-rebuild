...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Le/b/k/h;->a(Landroid/content/Context;I)I
    ...
    iput-object v1, p0, Le/b/k/h$a;->a:Landroidx/appcompat/app/AlertController$b;

    iput v0, p0, Le/b/k/h$a;->b:I
...
# virtual methods
.method public a(Ljava/lang/CharSequence;)Le/b/k/h$a;
    .locals 1

    iget-object v0, p0, Le/b/k/h$a;->a:Landroidx/appcompat/app/AlertController$b;
...
.method public a()Le/b/k/h;
    .locals 15

    new-instance v0, Le/b/k/h;

    iget-object v1, p0, Le/b/k/h$a;->a:Landroidx/appcompat/app/AlertController$b;

    iget-object v1, v1, Landroidx/appcompat/app/AlertController$b;->a:Landroid/content/Context;

    iget v2, p0, Le/b/k/h$a;->b:I

    invoke-direct {v0, v1, v2}, Le/b/k/h;-><init>(Landroid/content/Context;I)V

    iget-object v1, p0, Le/b/k/h$a;->a:Landroidx/appcompat/app/AlertController$b;

    iget-object v10, v0, Le/b/k/h;->h:Landroidx/appcompat/app/AlertController;
    ...
    invoke-direct/range {v3 .. v9}, Le/b/k/d;-><init>(Landroidx/appcompat/app/AlertController$b;Landroid/content/Context;II[Ljava/lang/CharSequence;Landroidx/appcompat/app/AlertController$RecycleListView;)V

    goto :goto_2

    :cond_d
    new-instance v14, Le/b/k/e;
    ...
    invoke-direct/range {v3 .. v9}, Le/b/k/e;-><init>(Landroidx/appcompat/app/AlertController$b;Landroid/content/Context;Landroid/database/Cursor;ZLandroidx/appcompat/app/AlertController$RecycleListView;Landroidx/appcompat/app/AlertController;)V
    ...
    new-instance v3, Le/b/k/f;

    invoke-direct {v3, v1, v10}, Le/b/k/f;-><init>(Landroidx/appcompat/app/AlertController$b;Landroidx/appcompat/app/AlertController;)V
    ...
    new-instance v3, Le/b/k/g;

    invoke-direct {v3, v1, v2, v10}, Le/b/k/g;-><init>(Landroidx/appcompat/app/AlertController$b;Landroidx/appcompat/app/AlertController$RecycleListView;Landroidx/appcompat/app/AlertController;)V
