...
# instance fields
.field public final a:Le/h/l/a;


# direct methods
.method public constructor <init>(Le/h/l/a;)V
    .locals 0

    invoke-direct {p0}, Landroid/view/View$AccessibilityDelegate;-><init>()V

    iput-object p1, p0, Le/h/l/a$a;->a:Le/h/l/a;
...
.method public dispatchPopulateAccessibilityEvent(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iget-object v0, p0, Le/h/l/a$a;->a:Le/h/l/a;
...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    .line 1
    iget-object p1, p1, Le/h/l/e0/c;->a:Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-direct {v1, v2}, Le/h/l/e0/b;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    .line 2
    invoke-static/range {p1 .. p1}, Le/h/l/t;->E(Landroid/view/View;)Z
    ...
    invoke-virtual {v1, v4, v3}, Le/h/l/e0/b;->a(IZ)V

    .line 4
    :goto_0
    new-instance v3, Le/h/l/t$b;

    sget v4, Le/h/b;->tag_accessibility_heading:I

    const-class v6, Ljava/lang/Boolean;

    invoke-direct {v3, v4, v6, v5}, Le/h/l/t$b;-><init>(ILjava/lang/Class;I)V

    .line 5
    invoke-virtual {v3, v0}, Le/h/l/t$d;->b(Landroid/view/View;)Ljava/lang/Object;
    ...
    iget-object v6, v1, Le/h/l/e0/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {v1, v6, v3}, Le/h/l/e0/b;->a(IZ)V

    .line 7
    :goto_2
    invoke-static/range {p1 .. p1}, Le/h/l/t;->d(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    .line 9
    :goto_3
    new-instance v3, Le/h/l/w;

    sget v5, Le/h/b;->tag_state_description:I
    ...
    invoke-direct {v3, v5, v6, v7, v8}, Le/h/l/w;-><init>(ILjava/lang/Class;II)V
    ...
    .line 11
    invoke-virtual {v1, v3}, Le/h/l/e0/b;->b(Ljava/lang/CharSequence;)V

    move-object/from16 v3, p0

    iget-object v5, v3, Le/h/l/a$a;->a:Le/h/l/a;

    invoke-virtual {v5, v0, v1}, Le/h/l/a;->a(Landroid/view/View;Le/h/l/e0/b;)V
    ...
    .line 14
    sget v5, Le/h/b;->tag_accessibility_clickable_spans:I
    ...
    .line 16
    :cond_6
    invoke-static {v2}, Le/h/l/e0/b;->c(Ljava/lang/CharSequence;)[Landroid/text/style/ClickableSpan;
    ...
    invoke-virtual {v1}, Le/h/l/e0/b;->c()Landroid/os/Bundle;

    move-result-object v10

    sget v11, Le/h/b;->accessibility_action_clickable_span:I
    ...
    .line 17
    sget v10, Le/h/b;->tag_accessibility_clickable_spans:I
    ...
    sget v11, Le/h/b;->tag_accessibility_clickable_spans:I
    ...
    :cond_9
    sget v12, Le/h/l/e0/b;->d:I

    add-int/lit8 v13, v12, 0x1

    sput v13, Le/h/l/e0/b;->d:I
    ...
    .line 22
    invoke-virtual {v1, v6}, Le/h/l/e0/b;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v1, v7}, Le/h/l/e0/b;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v1, v8}, Le/h/l/e0/b;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v1, v9}, Le/h/l/e0/b;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 23
    :cond_a
    sget v2, Le/h/b;->tag_accessibility_actions:I
    ...
    check-cast v4, Le/h/l/e0/b$a;

    invoke-virtual {v1, v4}, Le/h/l/e0/b;->a(Le/h/l/e0/b$a;)V
