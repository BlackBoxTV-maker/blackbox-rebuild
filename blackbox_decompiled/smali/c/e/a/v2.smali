...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-boolean v0, p0, Lc/e/a/v2;->e0:Z

    new-instance v0, Landroid/util/DisplayMetrics;

    invoke-direct {v0}, Landroid/util/DisplayMetrics;-><init>()V

    iput-object v0, p0, Lc/e/a/v2;->d0:Landroid/util/DisplayMetrics;
    ...
    iget-object v1, p0, Lc/e/a/v2;->d0:Landroid/util/DisplayMetrics;
    ...
    :cond_0
    iget-boolean v0, p0, Lc/e/a/v2;->e0:Z
    ...
    :cond_4
    new-instance p3, Lc/e/a/v2$a;

    invoke-direct {p3, p0}, Lc/e/a/v2$a;-><init>(Lc/e/a/v2;)V

    invoke-virtual {p2, p3}, Landroid/widget/CheckBox;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    new-instance p3, Lc/e/a/v2$b;

    invoke-direct {p3, p0, v0, v2}, Lc/e/a/v2$b;-><init>(Lc/e/a/v2;Landroid/widget/CheckBox;Landroid/widget/CheckBox;)V

    invoke-virtual {p2, p3}, Landroid/widget/CheckBox;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance p3, Lc/e/a/v2$c;

    invoke-direct {p3, p0, v2, p2}, Lc/e/a/v2$c;-><init>(Lc/e/a/v2;Landroid/widget/CheckBox;Landroid/widget/CheckBox;)V

    invoke-virtual {v0, p3}, Landroid/widget/CheckBox;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance p3, Lc/e/a/v2$d;

    invoke-direct {p3, p0, p2, v0}, Lc/e/a/v2$d;-><init>(Lc/e/a/v2;Landroid/widget/CheckBox;Landroid/widget/CheckBox;)V
