.class public final Llk/rtx/library/kenburnsview/MathUtils;
...
.method protected static haveSameAspectRatio(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    ...
    .line 47
    invoke-static {p0}, Llk/rtx/library/kenburnsview/MathUtils;->getRectRatio(Landroid/graphics/RectF;)F

    move-result v0

    const/4 v1, 0x3

    invoke-static {v0, v1}, Llk/rtx/library/kenburnsview/MathUtils;->truncate(FI)F

    move-result v0

    .line 48
    .local v0, "srcRectRatio":F
    invoke-static {p1}, Llk/rtx/library/kenburnsview/MathUtils;->getRectRatio(Landroid/graphics/RectF;)F

    move-result v2

    invoke-static {v2, v1}, Llk/rtx/library/kenburnsview/MathUtils;->truncate(FI)F
