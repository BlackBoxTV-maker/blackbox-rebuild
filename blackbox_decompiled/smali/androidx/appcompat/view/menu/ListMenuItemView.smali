...
# interfaces
.implements Le/b/o/i/o$a;
.implements Landroid/widget/AbsListView$SelectionBoundsAdjuster;


# instance fields
.field public f:Le/b/o/i/j;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Le/b/a;->listMenuViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Le/b/j;->MenuView:[I
    ...
    sget p3, Le/b/j;->MenuView_android_itemBackground:I

    invoke-virtual {p2, p3}, Le/b/p/a1;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->o:Landroid/graphics/drawable/Drawable;

    sget p3, Le/b/j;->MenuView_android_itemTextAppearance:I

    const/4 v0, -0x1

    invoke-virtual {p2, p3, v0}, Le/b/p/a1;->f(II)I

    move-result p3

    iput p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->p:I

    sget p3, Le/b/j;->MenuView_preserveIconSpacing:I

    invoke-virtual {p2, p3, v2}, Le/b/p/a1;->a(IZ)Z
    ...
    sget p3, Le/b/j;->MenuView_subMenuArrow:I
    ...
    sget v0, Le/b/a;->dropDownListViewStyle:I
    ...
    .line 1
    iget-object p2, p2, Le/b/p/a1;->b:Landroid/content/res/TypedArray;
...
.method public a(Le/b/o/i/j;I)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->f:Le/b/o/i/j;

    invoke-virtual {p1}, Le/b/o/i/j;->isVisible()Z
    ...
    .line 2
    invoke-interface {p0}, Le/b/o/i/o$a;->a()Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-virtual {p1}, Le/b/o/i/j;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    .line 3
    :cond_1
    iget-object p2, p1, Le/b/o/i/j;->e:Ljava/lang/CharSequence;

    .line 4
    :goto_1
    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Le/b/o/i/j;->isCheckable()Z

    move-result p2

    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->setCheckable(Z)V

    invoke-virtual {p1}, Le/b/o/i/j;->f()Z

    move-result p2

    invoke-virtual {p1}, Le/b/o/i/j;->b()C

    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->a(Z)V

    invoke-virtual {p1}, Le/b/o/i/j;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    iget-object p1, p1, Le/b/o/i/j;->r:Ljava/lang/CharSequence;
...
.method public a(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->f:Le/b/o/i/j;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->k:Landroid/widget/TextView;

    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->f:Le/b/o/i/j;

    .line 7
    invoke-virtual {v2}, Le/b/o/i/j;->b()C
    ...
    :cond_1
    iget-object v4, v2, Le/b/o/i/j;->n:Le/b/o/i/g;

    .line 8
    iget-object v4, v4, Le/b/o/i/g;->a:Landroid/content/Context;
    ...
    iget-object v6, v2, Le/b/o/i/j;->n:Le/b/o/i/g;

    .line 10
    iget-object v6, v6, Le/b/o/i/g;->a:Landroid/content/Context;
    ...
    sget v6, Le/b/h;->abc_prepend_shortcut_label:I
    ...
    invoke-virtual {v6}, Le/b/o/i/g;->f()Z

    move-result v6

    if-eqz v6, :cond_3

    iget v2, v2, Le/b/o/i/j;->k:I

    goto :goto_1

    :cond_3
    iget v2, v2, Le/b/o/i/j;->i:I

    :goto_1
    const/high16 v6, 0x10000

    sget v7, Le/b/h;->abc_menu_meta_shortcut_label:I

    invoke-virtual {v4, v7}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v2, v6, v7}, Le/b/o/i/j;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v6, 0x1000

    sget v7, Le/b/h;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v7, Le/b/h;->abc_menu_alt_shortcut_label:I
    ...
    sget v7, Le/b/h;->abc_menu_shift_shortcut_label:I
    ...
    sget v7, Le/b/h;->abc_menu_sym_shortcut_label:I
    ...
    sget v6, Le/b/h;->abc_menu_function_shortcut_label:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v2, v0, v6}, Le/b/o/i/j;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_4
    sget v0, Le/b/h;->abc_menu_space_shortcut_label:I

    goto :goto_2

    :cond_5
    sget v0, Le/b/h;->abc_menu_enter_shortcut_label:I

    goto :goto_2

    :cond_6
    sget v0, Le/b/h;->abc_menu_delete_shortcut_label:I
...
.method public final b()V
    ...
    sget v1, Le/b/g;->abc_list_menu_item_checkbox:I
...
.method public final c()V
    ...
    sget v1, Le/b/g;->abc_list_menu_item_radio:I
...
.method public getItemData()Le/b/o/i/j;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->f:Le/b/o/i/j;
...
.method public onFinishInflate()V
    ...
    iget v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->p:I
    ...
    :cond_1
    sget v0, Le/b/f;->group_divider:I
...
.method public setCheckable(Z)V
    ...
    invoke-virtual {v0}, Le/b/o/i/j;->e()Z
    ...
    invoke-virtual {p1}, Le/b/o/i/j;->isChecked()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    iget-object v0, v0, Le/b/o/i/j;->n:Le/b/o/i/g;

    .line 2
    iget-boolean v0, v0, Le/b/o/i/g;->t:Z
    ...
    sget v3, Le/b/g;->abc_list_menu_item_icon:I
