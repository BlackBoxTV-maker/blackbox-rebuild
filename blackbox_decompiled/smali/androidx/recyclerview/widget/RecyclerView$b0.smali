...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->i:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->h:Landroid/widget/OverScroller;
...
.method public a(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_4
    iget-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->i:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->i:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->h:Landroid/widget/OverScroller;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->h:Landroid/widget/OverScroller;
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$b0;->h:Landroid/widget/OverScroller;
...
.method public run()V
    ...
    iget-object v2, v1, Landroidx/recyclerview/widget/RecyclerView;->r:Landroidx/recyclerview/widget/RecyclerView$n;

    if-nez v2, :cond_0

    invoke-virtual/range {p0 .. p0}, Landroidx/recyclerview/widget/RecyclerView$b0;->b()V
    ...
    iput-boolean v3, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->j:Z

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView;->c()V

    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->h:Landroid/widget/OverScroller;
    ...
    iget v6, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->f:I

    sub-int v6, v4, v6

    iget v7, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->g:I

    sub-int v13, v5, v7

    iput v4, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->f:I

    iput v5, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->g:I
    ...
    iget-object v7, v4, Landroidx/recyclerview/widget/RecyclerView;->q:Landroidx/recyclerview/widget/RecyclerView$f;
    ...
    iget-object v9, v4, Landroidx/recyclerview/widget/RecyclerView;->r:Landroidx/recyclerview/widget/RecyclerView$n;
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$y;->b()V
    ...
    .line 6
    :cond_4
    invoke-virtual {v9, v8, v7}, Landroidx/recyclerview/widget/RecyclerView$y;->a(II)V
    ...
    iget-object v9, v9, Landroidx/recyclerview/widget/RecyclerView;->r:Landroidx/recyclerview/widget/RecyclerView$n;
    ...
    .line 7
    iget-boolean v9, v9, Landroidx/recyclerview/widget/RecyclerView$y;->d:Z
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->m0:Le/q/d/i$b;

    .line 9
    iget-object v4, v1, Le/q/d/i$b;->c:[I
    ...
    iget-object v4, v1, Landroidx/recyclerview/widget/RecyclerView;->l0:Le/q/d/i;

    if-eqz v4, :cond_18

    invoke-virtual {v4, v1, v8, v7}, Le/q/d/i;->a(Landroidx/recyclerview/widget/RecyclerView;II)V

    :cond_18
    :goto_8
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->l:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->r:Landroidx/recyclerview/widget/RecyclerView$n;
    ...
    .line 12
    invoke-virtual {v1, v2, v2}, Landroidx/recyclerview/widget/RecyclerView$y;->a(II)V

    :cond_19
    iput-boolean v2, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->j:Z

    iget-boolean v1, v0, Landroidx/recyclerview/widget/RecyclerView$b0;->k:Z
    ...
    invoke-static {v1, v0}, Le/h/l/t;->a(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, v3}, Landroidx/recyclerview/widget/RecyclerView;->h(I)V
