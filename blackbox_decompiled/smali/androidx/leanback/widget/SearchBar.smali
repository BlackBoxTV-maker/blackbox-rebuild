...
.field public f:Landroidx/leanback/widget/SearchBar$k;

.field public g:Landroidx/leanback/widget/SearchEditText;

.field public h:Landroidx/leanback/widget/SpeechOrbView;
...
.field public y:Landroid/speech/SpeechRecognizer;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/leanback/widget/SearchBar;->E:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroidx/leanback/widget/SearchBar;->n:Landroid/os/Handler;

    const/4 p2, 0x0

    iput-boolean p2, p0, Landroidx/leanback/widget/SearchBar;->p:Z
    ...
    sget v1, Le/n/h;->lb_search_bar:I
    ...
    sget v1, Le/n/c;->lb_search_bar_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroidx/leanback/widget/SearchBar;->x:I
    ...
    iput-object p2, p0, Landroidx/leanback/widget/SearchBar;->j:Ljava/lang/String;
    ...
    iput-object p2, p0, Landroidx/leanback/widget/SearchBar;->o:Landroid/view/inputmethod/InputMethodManager;

    sget p2, Le/n/b;->lb_search_bar_text_speech_mode:I
    ...
    sget p2, Le/n/b;->lb_search_bar_text:I
    ...
    sget p2, Le/n/g;->lb_search_bar_speech_mode_background_alpha:I
    ...
    sget p2, Le/n/g;->lb_search_bar_text_mode_background_alpha:I
    ...
    sget p2, Le/n/b;->lb_search_bar_hint_speech_mode:I
    ...
    sget p2, Le/n/b;->lb_search_bar_hint:I
...
.method public a()V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->o:Landroid/view/inputmethod/InputMethodManager;

    iget-object v1, p0, Landroidx/leanback/widget/SearchBar;->g:Landroidx/leanback/widget/SearchEditText;
...
.method public final a(I)V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->n:Landroid/os/Handler;
...
.method public a(Z)V
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchBar;->q:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchBar;->g:Landroidx/leanback/widget/SearchEditText;
    ...
    invoke-virtual {p0}, Landroidx/leanback/widget/SearchBar;->k()V
...
.method public final b()Z
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->h:Landroidx/leanback/widget/SpeechOrbView;
...
.method public c()V
    ...
    sget v0, Le/n/i;->lb_voice_failure:I

    invoke-virtual {p0, v0}, Landroidx/leanback/widget/SearchBar;->a(I)V
...
.method public d()V
    ...
    sget v0, Le/n/i;->lb_voice_open:I
...
.method public e()V
    ...
    sget v0, Le/n/i;->lb_voice_success:I
...
.method public g()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->y:Landroid/speech/SpeechRecognizer;
    ...
    iget-object v2, p0, Landroidx/leanback/widget/SearchBar;->y:Landroid/speech/SpeechRecognizer;
...
.method public getBadgeDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->m:Landroid/graphics/drawable/Drawable;
...
.method public getTitle()Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->l:Ljava/lang/String;
...
.method public h()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->g:Landroidx/leanback/widget/SearchEditText;
    ...
    iget-object v1, p0, Landroidx/leanback/widget/SearchBar;->y:Landroid/speech/SpeechRecognizer;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/leanback/widget/SearchBar;->h:Landroidx/leanback/widget/SpeechOrbView;
...
.method public j()V
    ...
    invoke-virtual {p0}, Landroidx/leanback/widget/SearchBar;->h()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Landroidx/leanback/widget/SearchBar;->g()V
...
.method public final k()V
    ...
    sget v1, Le/n/j;->lb_search_bar_hint:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Landroidx/leanback/widget/SearchBar;->l:Ljava/lang/String;
    ...
    sget v3, Le/n/j;->lb_search_bar_hint_with_title_speech:I

    new-array v2, v2, [Ljava/lang/Object;

    iget-object v4, p0, Landroidx/leanback/widget/SearchBar;->l:Ljava/lang/String;
    ...
    sget v3, Le/n/j;->lb_search_bar_hint_with_title:I
    ...
    sget v1, Le/n/j;->lb_search_bar_hint_speech:I
    ...
    :cond_2
    :goto_0
    iput-object v0, p0, Landroidx/leanback/widget/SearchBar;->k:Ljava/lang/String;
...
.method public onAttachedToWindow()V
    ...
    .line 1
    sget v5, Le/n/i;->lb_voice_failure:I

    aput v5, v4, v1

    sget v5, Le/n/i;->lb_voice_open:I

    aput v5, v4, v3

    sget v5, Le/n/i;->lb_voice_no_input:I

    aput v5, v4, v2

    sget v2, Le/n/i;->lb_voice_success:I
    ...
    iget-object v6, p0, Landroidx/leanback/widget/SearchBar;->B:Landroid/util/SparseIntArray;

    iget-object v7, p0, Landroidx/leanback/widget/SearchBar;->A:Landroid/media/SoundPool;

    invoke-virtual {v7, v0, v5, v3}, Landroid/media/SoundPool;->load(Landroid/content/Context;II)I
...
.method public onFinishInflate()V
    ...
    sget v0, Le/n/f;->lb_search_bar_items:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchBar;->q:Landroid/graphics/drawable/Drawable;

    sget v0, Le/n/f;->lb_search_text_editor:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchBar;->g:Landroidx/leanback/widget/SearchEditText;

    sget v0, Le/n/f;->lb_search_bar_badge:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchBar;->i:Landroid/widget/ImageView;

    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->m:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroidx/leanback/widget/SearchBar;->i:Landroid/widget/ImageView;
    ...
    sget v0, Le/n/f;->lb_search_bar_speech_orb:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchBar;->h:Landroidx/leanback/widget/SpeechOrbView;
    ...
    invoke-virtual {p0, v0}, Landroidx/leanback/widget/SearchBar;->a(Z)V
...
.method public setBadgeDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchBar;->m:Landroid/graphics/drawable/Drawable;

    iget-object v0, p0, Landroidx/leanback/widget/SearchBar;->i:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchBar;->i:Landroid/widget/ImageView;
...
.method public setSearchQueryInternal(Ljava/lang/String;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/leanback/widget/SearchBar;->j:Ljava/lang/String;

    return-void
.end method

.method public setSpeechRecognitionCallback(Le/n/n/t;)V
    .locals 0
...
.method public setSpeechRecognizer(Landroid/speech/SpeechRecognizer;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/leanback/widget/SearchBar;->y:Landroid/speech/SpeechRecognizer;
...
.method public setTitle(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchBar;->l:Ljava/lang/String;
