...
.field public n:[Landroidx/leanback/widget/PagingIndicator$d;
...
.field public final z:Landroid/animation/AnimatorSet;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/leanback/widget/PagingIndicator;->F:Landroid/animation/TimeInterpolator;
    ...
    invoke-direct {v0, v1, v2}, Landroidx/leanback/widget/PagingIndicator$a;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Landroidx/leanback/widget/PagingIndicator;->G:Landroid/util/Property;
    ...
    invoke-direct {v0, v1, v2}, Landroidx/leanback/widget/PagingIndicator$b;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Landroidx/leanback/widget/PagingIndicator;->H:Landroid/util/Property;
    ...
    invoke-direct {v0, v1, v2}, Landroidx/leanback/widget/PagingIndicator$c;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Landroidx/leanback/widget/PagingIndicator;->I:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Le/n/l;->PagingIndicator:[I
    ...
    sget p2, Le/n/l;->PagingIndicator_lbDotRadius:I

    sget p3, Le/n/c;->lb_page_indicator_dot_radius:I

    invoke-virtual {p0, p1, p2, p3}, Landroidx/leanback/widget/PagingIndicator;->a(Landroid/content/res/TypedArray;II)I

    move-result p2

    iput p2, p0, Landroidx/leanback/widget/PagingIndicator;->h:I

    iget p2, p0, Landroidx/leanback/widget/PagingIndicator;->h:I
    ...
    sget p2, Le/n/l;->PagingIndicator_arrowRadius:I

    sget v1, Le/n/c;->lb_page_indicator_arrow_radius:I
    ...
    iget p2, p0, Landroidx/leanback/widget/PagingIndicator;->k:I

    mul-int/2addr p2, p3

    iput p2, p0, Landroidx/leanback/widget/PagingIndicator;->j:I

    sget p2, Le/n/l;->PagingIndicator_dotToDotGap:I

    sget v1, Le/n/c;->lb_page_indicator_dot_gap:I
    ...
    sget p2, Le/n/l;->PagingIndicator_dotToArrowGap:I

    sget v1, Le/n/c;->lb_page_indicator_arrow_gap:I
    ...
    sget p2, Le/n/l;->PagingIndicator_dotBgColor:I

    sget v1, Le/n/b;->lb_page_indicator_dot:I
    ...
    iput-object v1, p0, Landroidx/leanback/widget/PagingIndicator;->w:Landroid/graphics/Paint;

    iget-object v1, p0, Landroidx/leanback/widget/PagingIndicator;->w:Landroid/graphics/Paint;

    invoke-virtual {v1, p2}, Landroid/graphics/Paint;->setColor(I)V

    sget p2, Le/n/l;->PagingIndicator_arrowBgColor:I

    sget v1, Le/n/b;->lb_page_indicator_arrow_background:I
    ...
    .line 10
    iput p2, p0, Landroidx/leanback/widget/PagingIndicator;->v:I

    iget-object p2, p0, Landroidx/leanback/widget/PagingIndicator;->C:Landroid/graphics/Paint;

    if-nez p2, :cond_0

    sget p2, Le/n/l;->PagingIndicator_arrowColor:I
    ...
    sget p1, Le/n/b;->lb_page_indicator_arrow_shadow:I

    invoke-virtual {v0, p1}, Landroid/content/res/Resources;->getColor(I)I

    move-result p1

    sget p2, Le/n/c;->lb_page_indicator_arrow_shadow_radius:I

    invoke-virtual {v0, p2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p2

    iput p2, p0, Landroidx/leanback/widget/PagingIndicator;->m:I

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2, v3}, Landroid/graphics/Paint;-><init>(I)V

    iput-object p2, p0, Landroidx/leanback/widget/PagingIndicator;->x:Landroid/graphics/Paint;

    sget p2, Le/n/c;->lb_page_indicator_arrow_shadow_offset:I
    ...
    iget-object p2, p0, Landroidx/leanback/widget/PagingIndicator;->B:Landroid/graphics/Bitmap;

    invoke-virtual {p2}, Landroid/graphics/Bitmap;->getWidth()I

    move-result p2

    iget-object v0, p0, Landroidx/leanback/widget/PagingIndicator;->B:Landroid/graphics/Bitmap;
    ...
    iget p2, p0, Landroidx/leanback/widget/PagingIndicator;->j:I
    ...
    iget-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->y:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, v4, v1}, Landroidx/leanback/widget/PagingIndicator;->a(FF)Landroid/animation/Animator;
    ...
    iget v6, p0, Landroidx/leanback/widget/PagingIndicator;->k:I

    mul-int/2addr v6, p3

    int-to-float v6, v6

    invoke-virtual {p0, v5, v6}, Landroidx/leanback/widget/PagingIndicator;->b(FF)Landroid/animation/Animator;

    move-result-object v5

    aput-object v5, v0, v3

    invoke-virtual {p0}, Landroidx/leanback/widget/PagingIndicator;->c()Landroid/animation/Animator;
    ...
    iput-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->z:Landroid/animation/AnimatorSet;

    iget-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->z:Landroid/animation/AnimatorSet;

    new-array p2, p2, [Landroid/animation/Animator;

    invoke-virtual {p0, v1, v4}, Landroidx/leanback/widget/PagingIndicator;->a(FF)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/leanback/widget/PagingIndicator;->b(FF)Landroid/animation/Animator;
    ...
    iget-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->A:Landroid/animation/AnimatorSet;
    ...
    iget-object p3, p0, Landroidx/leanback/widget/PagingIndicator;->z:Landroid/animation/AnimatorSet;
...
.method public final a(FF)Landroid/animation/Animator;
    ...
    sget-object p2, Landroidx/leanback/widget/PagingIndicator;->F:Landroid/animation/TimeInterpolator;
...
.method public final a()V
    ...
    iget v4, p0, Landroidx/leanback/widget/PagingIndicator;->u:I
    ...
    iget v4, v1, Landroidx/leanback/widget/PagingIndicator;->j:I

    int-to-float v4, v4

    iput v4, v0, Landroidx/leanback/widget/PagingIndicator$d;->e:F

    iget v4, v1, Landroidx/leanback/widget/PagingIndicator;->k:I

    int-to-float v4, v4

    iput v4, v0, Landroidx/leanback/widget/PagingIndicator$d;->f:F

    iget v4, v0, Landroidx/leanback/widget/PagingIndicator$d;->f:F
...
.method public final b()V
    ...
    iput-object v4, p0, Landroidx/leanback/widget/PagingIndicator;->p:[I

    new-array v2, v2, [I

    iput-object v2, p0, Landroidx/leanback/widget/PagingIndicator;->q:[I

    iget-boolean v2, p0, Landroidx/leanback/widget/PagingIndicator;->f:Z
    ...
    iget v7, p0, Landroidx/leanback/widget/PagingIndicator;->i:I

    sub-int/2addr v6, v7

    iget v8, p0, Landroidx/leanback/widget/PagingIndicator;->l:I
    ...
    iget v6, p0, Landroidx/leanback/widget/PagingIndicator;->l:I
...
.method public final c()Landroid/animation/Animator;
    ...
    sget-object v0, Landroidx/leanback/widget/PagingIndicator;->I:Landroid/util/Property;
    ...
    sget-object v1, Landroidx/leanback/widget/PagingIndicator;->F:Landroid/animation/TimeInterpolator;
...
.method public final d()Landroid/graphics/Bitmap;
    ...
    sget v1, Le/n/d;->lb_ic_nav_arrow:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v4, v3, Landroidx/leanback/widget/PagingIndicator;->r:I

    int-to-float v4, v4

    iget v5, v1, Landroidx/leanback/widget/PagingIndicator$d;->f:F

    iget-object v3, v3, Landroidx/leanback/widget/PagingIndicator;->w:Landroid/graphics/Paint;
    ...
    iget-object v3, v3, Landroidx/leanback/widget/PagingIndicator;->x:Landroid/graphics/Paint;
    ...
    iget-object v4, v3, Landroidx/leanback/widget/PagingIndicator;->B:Landroid/graphics/Bitmap;

    iget-object v5, v3, Landroidx/leanback/widget/PagingIndicator;->D:Landroid/graphics/Rect;

    new-instance v6, Landroid/graphics/Rect;

    iget v7, v1, Landroidx/leanback/widget/PagingIndicator$d;->g:F
    ...
    iget-object v1, v1, Landroidx/leanback/widget/PagingIndicator;->C:Landroid/graphics/Paint;
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-boolean v3, v3, Landroidx/leanback/widget/PagingIndicator;->f:Z
...
.method public setPageCount(I)V
    ...
    iget p1, p0, Landroidx/leanback/widget/PagingIndicator;->s:I
