...
.field public a1:Landroid/graphics/LinearGradient;
...
.field public e1:Landroid/graphics/LinearGradient;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Le/n/n/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance p3, Landroid/graphics/Paint;

    invoke-direct {p3}, Landroid/graphics/Paint;-><init>()V

    iput-object p3, p0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;

    new-instance p3, Landroid/graphics/Rect;

    invoke-direct {p3}, Landroid/graphics/Rect;-><init>()V

    iput-object p3, p0, Landroidx/leanback/widget/HorizontalGridView;->h1:Landroid/graphics/Rect;

    iget-object p3, p0, Le/n/n/a;->P0:Le/n/n/e;

    const/4 v0, 0x0

    invoke-virtual {p3, v0}, Le/n/n/e;->s(I)V
...
.method private getTempBitmapHigh()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Landroidx/leanback/widget/HorizontalGridView;->d1:Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    :cond_0
    iget v0, p0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/HorizontalGridView;->d1:Landroid/graphics/Bitmap;
...
.method public final K()V
    ...
    iget-boolean v0, p0, Landroidx/leanback/widget/HorizontalGridView;->W0:Z
...
.method public b(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p1, p2}, Le/n/n/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;)V

    sget-object v0, Le/n/l;->lbHorizontalGridView:[I
    ...
    sget p2, Le/n/l;->lbHorizontalGridView_numberOfRows:I
    ...
    invoke-virtual {p0}, Landroidx/leanback/widget/HorizontalGridView;->K()V

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;

    iget-object p1, p0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 1
    iget-boolean v2, v0, Landroidx/leanback/widget/HorizontalGridView;->W0:Z
    ...
    iget-object v7, v0, Le/n/n/a;->P0:Le/n/n/e;

    invoke-virtual {v7, v6}, Le/n/n/e;->t(Landroid/view/View;)I
    ...
    .line 2
    :goto_1
    iget-boolean v5, v0, Landroidx/leanback/widget/HorizontalGridView;->X0:Z
    ...
    invoke-virtual {v7, v6}, Le/n/n/e;->u(Landroid/view/View;)I
    ...
    .line 3
    iput-object v5, v0, Landroidx/leanback/widget/HorizontalGridView;->Z0:Landroid/graphics/Bitmap;

    :cond_6
    if-nez v3, :cond_7

    iput-object v5, v0, Landroidx/leanback/widget/HorizontalGridView;->d1:Landroid/graphics/Bitmap;
    ...
    :cond_8
    iget-boolean v6, v0, Landroidx/leanback/widget/HorizontalGridView;->W0:Z
    ...
    iget v7, v0, Landroidx/leanback/widget/HorizontalGridView;->b1:I
    ...
    :goto_4
    iget-boolean v7, v0, Landroidx/leanback/widget/HorizontalGridView;->X0:Z
    ...
    iget v8, v0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iget-boolean v9, v0, Landroidx/leanback/widget/HorizontalGridView;->W0:Z

    if-eqz v9, :cond_b

    iget v9, v0, Landroidx/leanback/widget/HorizontalGridView;->b1:I
    ...
    iget-boolean v10, v0, Landroidx/leanback/widget/HorizontalGridView;->X0:Z

    if-eqz v10, :cond_c

    iget v10, v0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iget-object v9, v0, Landroidx/leanback/widget/HorizontalGridView;->h1:Landroid/graphics/Rect;
    ...
    iget v11, v0, Landroidx/leanback/widget/HorizontalGridView;->b1:I
    ...
    iget-object v10, v0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;

    iget-object v12, v0, Landroidx/leanback/widget/HorizontalGridView;->a1:Landroid/graphics/LinearGradient;
    ...
    iget-object v12, v0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;
    ...
    iget-object v10, v0, Landroidx/leanback/widget/HorizontalGridView;->h1:Landroid/graphics/Rect;

    iput v4, v10, Landroid/graphics/Rect;->left:I

    iget v12, v0, Landroidx/leanback/widget/HorizontalGridView;->b1:I
    ...
    iget-object v6, v0, Landroidx/leanback/widget/HorizontalGridView;->h1:Landroid/graphics/Rect;
    ...
    iget v2, v0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iget v6, v0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iget-object v3, v0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;

    iget-object v6, v0, Landroidx/leanback/widget/HorizontalGridView;->e1:Landroid/graphics/LinearGradient;
    ...
    iget v3, v0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iget-object v6, v0, Landroidx/leanback/widget/HorizontalGridView;->Y0:Landroid/graphics/Paint;
    ...
    iget-object v3, v0, Landroidx/leanback/widget/HorizontalGridView;->h1:Landroid/graphics/Rect;

    iput v4, v3, Landroid/graphics/Rect;->left:I

    iget v4, v0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
...
.method public final setFadingLeftEdge(Z)V
    ...
    iput-boolean p1, p0, Landroidx/leanback/widget/HorizontalGridView;->W0:Z

    iget-boolean p1, p0, Landroidx/leanback/widget/HorizontalGridView;->W0:Z
...
.method public final setFadingLeftEdgeLength(I)V
    ...
    iget p1, p0, Landroidx/leanback/widget/HorizontalGridView;->b1:I
    ...
    iput-object v8, p0, Landroidx/leanback/widget/HorizontalGridView;->a1:Landroid/graphics/LinearGradient;
...
.method public final setFadingRightEdge(Z)V
    ...
    iget-boolean p1, p0, Landroidx/leanback/widget/HorizontalGridView;->X0:Z

    if-nez p1, :cond_0

    const/4 p1, 0x0

    iput-object p1, p0, Landroidx/leanback/widget/HorizontalGridView;->d1:Landroid/graphics/Bitmap;
...
.method public final setFadingRightEdgeLength(I)V
    ...
    iput p1, p0, Landroidx/leanback/widget/HorizontalGridView;->f1:I

    iget p1, p0, Landroidx/leanback/widget/HorizontalGridView;->f1:I
    ...
    iput-object v8, p0, Landroidx/leanback/widget/HorizontalGridView;->e1:Landroid/graphics/LinearGradient;
    ...
    iput-object p1, p0, Landroidx/leanback/widget/HorizontalGridView;->e1:Landroid/graphics/LinearGradient;
...
.method public setNumRows(I)V
    ...
    invoke-virtual {v0, p1}, Le/n/n/e;->r(I)V
...
.method public setRowHeight(I)V
    ...
    invoke-virtual {v0, p1}, Le/n/n/e;->t(I)V
...
.method public setRowHeight(Landroid/content/res/TypedArray;)V
    ...
    sget v0, Le/n/l;->lbHorizontalGridView_rowHeight:I
