...
.field public k:Landroidx/leanback/widget/SearchOrbView$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Le/n/a;->searchOrbViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->t:Landroid/animation/ArgbEvaluator;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->u:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->w:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->g:Landroid/view/View;

    sget v2, Le/n/f;->search_orb:I

    invoke-virtual {v1, v2}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroid/view/View;

    iget-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->g:Landroid/view/View;

    sget v2, Le/n/f;->icon:I
    ...
    iput-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->i:Landroid/widget/ImageView;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Le/n/e;->lb_search_orb_focused_zoom:I
    ...
    sget v2, Le/n/g;->lb_search_orb_pulse_duration_ms:I
    ...
    sget v2, Le/n/g;->lb_search_orb_scale_duration_ms:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v1

    iput v1, p0, Landroidx/leanback/widget/SearchOrbView;->n:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Le/n/c;->lb_search_orb_focused_z:I
    ...
    iput v1, p0, Landroidx/leanback/widget/SearchOrbView;->p:F

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Le/n/c;->lb_search_orb_unfocused_z:I
    ...
    sget-object v1, Le/n/l;->lbSearchOrbView:[I
    ...
    sget p2, Le/n/l;->lbSearchOrbView_searchOrbIcon:I
    ...
    sget p2, Le/n/d;->lb_ic_in_app_search:I
    ...
    sget p2, Le/n/b;->lb_default_search_color:I

    invoke-virtual {v0, p2}, Landroid/content/res/Resources;->getColor(I)I

    move-result p2

    sget p3, Le/n/l;->lbSearchOrbView_searchOrbColor:I

    invoke-virtual {p1, p3, p2}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result p2

    sget p3, Le/n/l;->lbSearchOrbView_searchOrbBrightColor:I

    invoke-virtual {p1, p3, p2}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result p3

    sget v0, Le/n/l;->lbSearchOrbView_searchOrbIconColor:I
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->i:Landroid/widget/ImageView;

    iget p2, p0, Landroidx/leanback/widget/SearchOrbView;->p:F

    invoke-static {p1, p2}, Le/h/l/t;->b(Landroid/view/View;F)V
...
.method public final a()V
    ...
    iget-boolean v0, p0, Landroidx/leanback/widget/SearchOrbView;->s:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->t:Landroid/animation/ArgbEvaluator;
    ...
    iget-object v3, p0, Landroidx/leanback/widget/SearchOrbView;->k:Landroidx/leanback/widget/SearchOrbView$c;
    ...
    iget-object v2, p0, Landroidx/leanback/widget/SearchOrbView;->k:Landroidx/leanback/widget/SearchOrbView$c;
    ...
    iget-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->u:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public a(F)V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroid/view/View;
...
.method public a(Z)V
    ...
    iget v1, p0, Landroidx/leanback/widget/SearchOrbView;->n:I
    ...
    iget v0, p0, Landroidx/leanback/widget/SearchOrbView;->n:I

    .line 1
    iget-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->v:Landroid/animation/ValueAnimator;
    ...
    iput-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->v:Landroid/animation/ValueAnimator;

    iget-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->v:Landroid/animation/ValueAnimator;

    iget-object v2, p0, Landroidx/leanback/widget/SearchOrbView;->w:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method public b(Z)V
    ...
    iput-boolean p1, p0, Landroidx/leanback/widget/SearchOrbView;->r:Z

    invoke-virtual {p0}, Landroidx/leanback/widget/SearchOrbView;->a()V
...
.method public getLayoutResourceId()I
    ...
    sget v0, Le/n/h;->lb_search_orb:I
...
.method public getOrbColor()I
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->k:Landroidx/leanback/widget/SearchOrbView$c;
...
.method public getOrbIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->j:Landroid/graphics/drawable/Drawable;
...
.method public onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Landroidx/leanback/widget/SearchOrbView;->s:Z
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->f:Landroid/view/View$OnClickListener;
...
.method public setOnOrbClickedListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->f:Landroid/view/View$OnClickListener;
...
.method public setOrbColors(Landroidx/leanback/widget/SearchOrbView$c;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->k:Landroidx/leanback/widget/SearchOrbView$c;
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->k:Landroidx/leanback/widget/SearchOrbView$c;
...
.method public setOrbIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->j:Landroid/graphics/drawable/Drawable;
...
.method public setSearchOrbZ(F)V
    ...
    iget v1, p0, Landroidx/leanback/widget/SearchOrbView;->o:F

    iget v2, p0, Landroidx/leanback/widget/SearchOrbView;->p:F
    ...
    invoke-static {v0, v2}, Le/h/l/t;->b(Landroid/view/View;F)V
