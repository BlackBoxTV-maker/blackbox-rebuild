...
.field public static final l:Landroidx/leanback/transition/SlideKitkat$g;

.field public static final m:Landroidx/leanback/transition/SlideKitkat$g;

.field public static final n:Landroidx/leanback/transition/SlideKitkat$g;


# instance fields
.field public f:Landroidx/leanback/transition/SlideKitkat$g;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/leanback/transition/SlideKitkat;->g:Landroid/animation/TimeInterpolator;

    new-instance v0, Landroid/view/animation/AccelerateInterpolator;

    invoke-direct {v0}, Landroid/view/animation/AccelerateInterpolator;-><init>()V

    sput-object v0, Landroidx/leanback/transition/SlideKitkat;->h:Landroid/animation/TimeInterpolator;
    ...
    sput-object v0, Landroidx/leanback/transition/SlideKitkat;->l:Landroidx/leanback/transition/SlideKitkat$g;
    ...
    sput-object v0, Landroidx/leanback/transition/SlideKitkat;->m:Landroidx/leanback/transition/SlideKitkat$g;
    ...
    sput-object v0, Landroidx/leanback/transition/SlideKitkat;->n:Landroidx/leanback/transition/SlideKitkat$g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Le/n/l;->lbSlide_lb_slideEdge:I
    ...
    sget v0, Le/n/l;->lbSlide_android_duration:I
    ...
    :cond_0
    sget v0, Le/n/l;->lbSlide_android_startDelay:I
    ...
    :cond_1
    sget v0, Le/n/l;->lbSlide_android_interpolator:I
...
.method public final a(Landroid/view/View;Landroid/util/Property;FFFLandroid/animation/TimeInterpolator;I)Landroid/animation/Animator;
    ...
    sget v0, Le/n/f;->lb_slide_transition_value:I
...
.method public a(I)V
    ...
    sget-object p1, Landroidx/leanback/transition/SlideKitkat;->n:Landroidx/leanback/transition/SlideKitkat$g;
    ...
    :cond_1
    sget-object p1, Landroidx/leanback/transition/SlideKitkat;->m:Landroidx/leanback/transition/SlideKitkat$g;

    goto :goto_0

    :cond_2
    sget-object p1, Landroidx/leanback/transition/SlideKitkat;->l:Landroidx/leanback/transition/SlideKitkat$g;
    ...
    :cond_4
    sget-object p1, Landroidx/leanback/transition/SlideKitkat;->k:Landroidx/leanback/transition/SlideKitkat$g;
    ...
    :goto_0
    iput-object p1, p0, Landroidx/leanback/transition/SlideKitkat;->f:Landroidx/leanback/transition/SlideKitkat$g;
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/transition/TransitionValues;ILandroid/transition/TransitionValues;I)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object p1, p0, Landroidx/leanback/transition/SlideKitkat;->f:Landroidx/leanback/transition/SlideKitkat$g;
    ...
    invoke-interface {p1}, Landroidx/leanback/transition/SlideKitkat$g;->a()Landroid/util/Property;

    move-result-object v2

    sget-object v6, Landroidx/leanback/transition/SlideKitkat;->g:Landroid/animation/TimeInterpolator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroid/transition/TransitionValues;ILandroid/transition/TransitionValues;I)Landroid/animation/Animator;
    ...
    sget-object v6, Landroidx/leanback/transition/SlideKitkat;->h:Landroid/animation/TimeInterpolator;
