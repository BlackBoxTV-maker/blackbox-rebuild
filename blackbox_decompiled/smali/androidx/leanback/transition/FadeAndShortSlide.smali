...
.field public static final l:Landroidx/leanback/transition/FadeAndShortSlide$g;

.field public static final m:Landroidx/leanback/transition/FadeAndShortSlide$g;

.field public static final n:Landroidx/leanback/transition/FadeAndShortSlide$g;

.field public static final o:Landroidx/leanback/transition/FadeAndShortSlide$g;


# instance fields
.field public f:Landroidx/leanback/transition/FadeAndShortSlide$g;

.field public g:Landroid/transition/Visibility;

.field public h:F

.field public final i:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/leanback/transition/FadeAndShortSlide;->j:Landroid/animation/TimeInterpolator;
    ...
    sput-object v0, Landroidx/leanback/transition/FadeAndShortSlide;->o:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/transition/Visibility;

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->h:F
    ...
    iput-object v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->i:Landroidx/leanback/transition/FadeAndShortSlide$g;

    invoke-virtual {p0, p1}, Landroidx/leanback/transition/FadeAndShortSlide;->a(I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Le/n/l;->lbSlide:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Le/n/l;->lbSlide_lb_slideEdge:I
    ...
    invoke-virtual {p0, p2}, Landroidx/leanback/transition/FadeAndShortSlide;->a(I)V
...
.method public a(Landroid/view/ViewGroup;)F
    ...
    iget v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->h:F
...
.method public a(I)V
    ...
    :cond_3
    iget-object p1, p0, Landroidx/leanback/transition/FadeAndShortSlide;->i:Landroidx/leanback/transition/FadeAndShortSlide$g;
    ...
    :cond_5
    sget-object p1, Landroidx/leanback/transition/FadeAndShortSlide;->o:Landroidx/leanback/transition/FadeAndShortSlide$g;

    :goto_0
    iput-object p1, p0, Landroidx/leanback/transition/FadeAndShortSlide;->f:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
.method public addListener(Landroid/transition/Transition$TransitionListener;)Landroid/transition/Transition;
    ...
    iget-object v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/transition/Visibility;
...
.method public clone()Landroid/transition/Transition;
    ...
    iget-object v1, p0, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/transition/Visibility;
    ...
    iput-object v1, v0, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/transition/Visibility;
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-object v1, v10, Landroidx/leanback/transition/FadeAndShortSlide;->f:Landroidx/leanback/transition/FadeAndShortSlide$g;
    ...
    sget-object v8, Landroidx/leanback/transition/FadeAndShortSlide;->j:Landroid/animation/TimeInterpolator;
    ...
    invoke-static/range {v0 .. v9}, Ld/a/a/a/a;->a(Landroid/view/View;Landroid/transition/TransitionValues;IIFFFFLandroid/animation/TimeInterpolator;Landroid/transition/Transition;)Landroid/animation/Animator;

    move-result-object v0

    iget-object v1, v10, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/transition/Visibility;
